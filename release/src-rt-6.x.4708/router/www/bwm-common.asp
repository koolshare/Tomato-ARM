...
var colorX = 0;
var colors = [
	['<% translate("Green"); %> &amp; <% translate("Blue"); %>', '#118811', '#6495ed'], ['<% translate("Blue"); %> &amp; <% translate("Orange"); %>', '#003EBA', '#FF9000'],
	['<% translate("Blue"); %> &amp; <% translate("Red"); %>', '#003EDD', '#CC4040'], ['<% translate("Blue"); %>', '#22f', '#225'], ['<% translate("Gray"); %>', '#000', '#999'],
	['<% translate("Red"); %> &amp; <% translate("Black"); %>', '#d00', '#000']];
//var hostnamecache = [];
