...
<div class='section-title' id='stitle' onclick='document.location="qos-graphs.asp"' style='cursor:pointer'><% translate("View Details"); %>: QoS <span id='numtotalconn'></span></div>
<div class='section'>
