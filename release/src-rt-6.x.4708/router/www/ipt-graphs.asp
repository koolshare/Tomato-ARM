...
<title>[<% ident(); %>] <% translate("IP Traffic"); %>: <% translate("View Graphs"); %></title>
...
<div class="section-title"><% translate("Connections Distribution"); %> (TCP/UDP)</div>
<div class="section">
...
<div class="section-title"><% translate("Bandwidth Distribution"); %> (<% translate("Inbound"); %>)</div>
<div class="section">
<table border=0 width="100%"><tr><td>
	<table style="width:250px">
...
for (i = 0; i < 11; ++i) {
	...
	<tr><td>&nbsp;</td><td class="total"><% translate("Total"); %></a></td><td id="obcnt-total" class="total count"></td><td id="obcntx-total" class="total count"></td><td class="total pct">100%</td></tr>
	</table>
</td><td style="margin-right:150px">
<script type='text/javascript'>
if (nvram.web_svg != '0') {
...
if (nvram.cstats_enable != '1') {
	W('<div class="note-disabled"><b><% translate("IP Traffic monitoring disabled"); %>.</b> &nbsp; <a href="admin-iptraffic.asp"><% translate("Enable"); %>&nbsp;&raquo;</a></div>');
}
</script>
