...
createFieldTable('', [
	...
	{ title: '<% translate("Do not restart the following process if they die"); %>', multi: [
		{ name: 'f_nr_crond', type: 'checkbox', suffix: ' <% translate("crond"); %><br>', value: (nvram.debug_norestart.indexOf('crond') != -1) },
		{ name: 'f_nr_dnsmasq', type: 'checkbox', suffix: ' <% translate("dnsmasq"); %><br>', value: (nvram.debug_norestart.indexOf('dnsmasq') != -1) },
/* LINUX26-BEGIN */
		{ name: 'f_nr_hotplug2', type: 'checkbox', suffix: ' <% translate("hotplug2"); %><br>', value: (nvram.debug_norestart.indexOf('hotplug2') != -1) },
/* LINUX26-END */
		{ name: 'f_nr_igmprt', type: 'checkbox', suffix: ' <% translate("igmprt"); %><br>', value: (nvram.debug_norestart.indexOf('igmprt') != -1) }
	] }
]);
</script>
<br><br>
