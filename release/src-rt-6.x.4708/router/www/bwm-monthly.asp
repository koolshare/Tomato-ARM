...
<title>[<% ident(); %>] <% translate("Bandwidth"); %>: <% translate("Monthly"); %></title>
...
<div class='section-title'><% translate("WAN Bandwidth - Monthly"); %></div>
<div id='bwm-monthly-grid' style='float:left'></div>
<div style="float:right;text-align:right">
<b><% translate("Date"); %></b> <select onchange='changeDate(this, "ym")' id='dafm'><option value=0>yyyy-mm</option><option value=1>mm-yyyy</option><option value=2>mmm yyyy</option><option value=3>mm.yyyy</option></select><br>
