...
<title>[<% ident(); %>] <% translate("Error"); %></title></head>
...
<input type='button' value='<% translate("Back"); %>' onclick='history.go(-1)' style='font:12px sans-serif;width:80px;margin-left:10px'>
</b></form></td></tr>
</table></body></html>
