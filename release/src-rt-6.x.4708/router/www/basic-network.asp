...
/* REMOVE-END */
<div class='section-title' id='mwan-title'><% translate("MultiWAN"); %></div>
...
createFieldTable('', [
	{ title: '<% translate("Number of WAN Ports"); %>', name: 'mwan_num', type: 'select', options: [['1','1 <% translate("WAN"); %>'],['2','2 <% translate("WAN"); %>']
/* MULTIWAN-BEGIN */
...
for(var uidx = 1; uidx <= maxwan_num; ++uidx) {
	...
	W('<div class=\'section-title\' id=\'wan'+u+'-title\'>WAN'+u+' <% translate("Settings"); %></div>');
