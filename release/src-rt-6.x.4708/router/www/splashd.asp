...
<title>[<% ident(); %>] <% translate("Captive Portal"); %></title>
...
createFieldTable('', [
	...
	{ title: '<% translate("Logged Timeout"); %>', name: 'NC_LoginTimeout', type: 'text', maxlen: 8, size: 4, value: nvram.NC_LoginTimeout, suffix: ' <small><% translate("seconds"); %></small>' },
	{ title: '<% translate("Idle Timeout"); %>', name: 'NC_IdleTimeout', type: 'text', maxlen: 8, size: 4, value: nvram.NC_IdleTimeout, suffix: ' <small><% translate("seconds"); %> (0 - <% translate("unlimited"); %>)</small>' },
...
<div class='section' id='upload-section'>
 ...
 <input type='button' name='f_upload_button' id='upload-button' value='<% translate("Upload"); %>' onclick='uploadButton()'>
 <br>
 </form>
</div>
<hr>
