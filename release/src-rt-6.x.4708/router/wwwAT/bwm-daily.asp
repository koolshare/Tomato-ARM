...
--><title><% translate("Bandwidth"); %>: <% translate("Daily"); %></title>
<content>
	<style>
	...
	<script type="text/javascript">
		//	<% nvram("at_update,tomatoanon_answer,wan_ifname,wan2_ifname,wan3_ifname,wan4_ifname,lan_ifname,rstats_enable"); %>
		...
		function redraw()
		{
			...
			grid += '<tr><td style="width:25%;"><b><% translate("Date"); %></b></td><td style="width:25%;"><b><% translate("Downloaded"); %></b></td><td style="width:25%;"><b><% translate("Uploaded"); %></b></th><td style="width:25%;"><b><% translate("Total"); %></b></td></tr>';
	...
	<div id="rstats" class="box">
		<div class="heading"><% translate("Daily Bandwidth"); %> <a class="pull-right" href="#" data-toggle="tooltip" title="<% translate("Reload Information"); %>" onclick="reloadPage(); return false;"><i class="icon-reboot"></i></a></div>
		<div class="content">
