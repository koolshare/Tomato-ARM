...
--><title><% translate("Firmware Upgrade"); %></title>
<content>
	<style>
		#afu-progress {
			display: block;
	...
	<div id="afu-input">
		...
		<form name="form_upgrade" method="post" action="upgrade.cgi" encType="multipart/form-data">
			...
			<div class="box">
				<div class="heading"><% translate("Router Upgrade"); %></div>
				<div class="content">
					...
					<fieldset>
						<label class="control-left-label col-sm-3" for="f_reset"><% translate("Restore defaults"); %></label>
						<div class="col-sm-9">
							<div id="reset-input">
			...
			<div class="box">
				<div class="heading"><% translate("Router Info"); %></div>
				<div class="content">
					<table class="line-table" id="version-table">
						<tr><td><% translate("Current Version"); %>:</td><td>&nbsp; <% version(1); %> <small></td></tr>
					</table>
				</div>
			</div>
