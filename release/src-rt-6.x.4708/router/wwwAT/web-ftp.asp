...
--><title><% translate("FTP Server"); %></title>
<content>
	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="box" data-box="ftp-dirs">
			<div class="heading"><% translate("Directories"); %></div>
			<div class="content">
			...
			<script type="text/javascript">
				$('#ftp-limits').forms([
					...
					{ title: '<% translate("Maximum Bandwidth for Anonymous Users"); %>', name: 'ftp_anonrate', type: 'text', maxlen: 5, size: 7,
						suffix: ' <% translate("KB/s"); %> <small>(0 - <% translate("unlimited"); %>)</small>',
					...
					{ title: '<% translate("Idle Timeout"); %>', name: 'ftp_staytimeout', type: 'text', maxlen: 5, size: 7,
						suffix: ' <% translate("seconds"); %> <small>(0 - <% translate("no timeout"); %>)</small>',
		...
		<div class="box" data-box="ftp-cust">
			<div class="heading"><% translate("Custom Configuration"); %></div>
		...
		<div class="box" data-box="ftp-usr-acc">
			<div class="heading"><% translate("User Accounts"); %></div>
			<div class="content">
