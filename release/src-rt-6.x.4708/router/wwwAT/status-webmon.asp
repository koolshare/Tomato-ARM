...
--><title><% translate("Web Usage"); %></title>
	...
	<script type="text/javascript">
		...
		function clearLog(clear)
		{
			...
			xob.onCompleted = function(text, xml) {
				xob = null;
				E('clear' + clear).innerHTML = '<a class="btn btn-primary btn-small" href="javascript:clearLog(' + clear + ')"><% translate("Clear Log"); %> <i class="icon-cancel"></i></a>';
			...
			E('clear' + clear).innerHTML = '<% translate("Please wait"); %>... <div class="spinner"></div>';
		}
	...
	<div class="row" id="webmon" style="display:none">
		<div class="col-lg-12">
			<div id="webmon-domains" class="box">
				<div class="heading"><% translate("Recently Visited Web Sites"); %></div>
				<div class="content">
					<table id="dom-grid" class="line-table"></table>
					<br /><div id="clear1">
						<a class="btn btn-primary btn-small" href="javascript:clearLog(1)"><% translate("Clear Log"); %> <i class="icon-cancel"></i></a>
						<a class="btn btn-small" href="webmon_recent_domains?_http_id=<% nv(http_id) %>"><% translate("Download"); %> <i class="icon-download"></i></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-lg-12">
			<div id="webmon-searches" class="box">
				<div class="heading"><% translate("Recent Web Searches"); %></div>
				<div class="content">
					<table id="srh-grid" class="line-table"></table>
					<br /><div id="clear2">
						<a class="btn btn-primary btn-small" href="javascript:clearLog(2)"><% translate("Clear Log"); %> <i class="icon-cancel"></i></a>
						<a class="btn btn-small" href="webmon_recent_searches?_http_id=<% nv(http_id) %>"><% translate("Download"); %> <i class="icon-download"></i></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="webmon-controls">
			...
			&raquo; <a class="ajaxload" href="admin-log.asp"><% translate("Web Monitor Configuration"); %></a>
			<br><br>
		</div>
	</div>
