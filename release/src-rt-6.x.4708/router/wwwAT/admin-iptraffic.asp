				...
				<script type='text/javascript'>
					...
					$('#iptconfig').forms([
						...
						{ title: '<% translate("Save History Location"); %>', multi: [
							/* REMOVE-BEGIN
							//	{ name: 'f_loc', type: 'select', options: [['','RAM (Temporary)'],['*nvram','NVRAM'],['/jffs/','JFFS2'],['/cifs1/','CIFS 1'],['/cifs2/','CIFS 2'],['*user','<% translate("Custom Path"); %>']], value: loc },
							REMOVE-END */
							{ name: 'f_loc', type: 'select', options: [['','<% translate("RAM (Temporary)"); %>'],['/jffs/','JFFS2'],['/cifs1/','CIFS 1'],['/cifs2/','CIFS 2'],['*user','<% translate("Custom Path"); %>']], value: loc },
