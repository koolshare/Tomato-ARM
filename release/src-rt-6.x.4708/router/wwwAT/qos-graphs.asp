...
--><title><% translate("View Graphs"); %></title>
<content>
	<style type="text/css">
		.color {
			width: 12px;
	...
	<div class="fluid-grid x2">
		<div class="box graphs">
			<div class="heading"><% translate("Bandwidth Distribution (Outbound)"); %></div>
			<div class="content">
		...
		<div class="box graphs">
			<div class="heading"><% translate("Bandwidth Distribution (Inbound)"); %></div>
			<div class="content">
	...
	<button name="mybtn" value="<% translate("Zoom Graphs"); %>" type="button" onclick="showGraph()" class="btn"><% translate("Zoom Graphs"); %> <i class="icon-search"></i></button>
