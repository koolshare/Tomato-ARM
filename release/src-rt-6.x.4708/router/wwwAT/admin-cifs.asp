...
--><title><% translate("CIFS Client"); %></title>
<content>
		...
		<div class="fluid-gr" id="mounties">
			<script type="text/javascript">
				...
				createFormFields([
					...
					{ title: '<% translate("UNC"); %>', indent: 2, name: 'f_cifs1_unc', type: 'text', maxlen: 128, size: 48, value: a[1] },
					{ title: '<% translate("Netbios Name"); %>', indent: 2, name: 'f_cifs1_servern', type: 'text', maxlen: 128, size: 48, value: a[6] },
				...
				createFormFields([
					...
					{ title: '<% translate("UNC"); %>', indent: 2, name: 'f_cifs2_unc', type: 'text', maxlen: 128, size: 48, value: b[1] },
					{ title: '<% translate("Netbios Name"); %>', indent: 2, name: 'f_cifs2_servern', type: 'text', maxlen: 128, size: 48, value: b[6] },
