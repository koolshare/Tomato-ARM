...
--><title><% translate("PPTP Online"); %></title>
<content>
	<style type="text/css">
		#dev-grid .co1 {
			width: 10%;
	...
	<script type="text/javascript">
		...
		dg.populate = function() {
			...
			for (i = list.length - 1; i >= 0; --i) {
				e = list[i];
				hangup = '<div id="div_'+e.pid+'"><a href="javascript:disconnect(\'div_'+e.pid + '\',' + e.pid + ')" title="Disconnect" id="pid_' + e.pid + '"><% translate("Disconnect"); %></a></div>';
				/* REMOVE-BEGIN */
				//		this.insert(-1, e, [
	...
	<div class="box">
		<div class="heading"><% translate("PPTP Users Online"); %></div>
		<div class="content">
			<table id="dev-grid" class="line-table"></table><br />
		</div>
	</div>

	<a href="vpn-pptp-server.asp" class="btn btn-danger ajaxload"><% translate("Configure"); %> <i class="icon-tools"></i></a>
