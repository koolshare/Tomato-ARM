...
--><title><% translate("IP Traffic"); %>: <% translate("Monthly History"); %></title>
<content>
	<style type="text/css">
		#monthly-grid .co3,
		#monthly-grid .co4,
	...
	<div id="cstats" class="box">
		<div class="heading"><% translate("Monthly IP Traffic"); %> <a class="pull-right" href="#" data-toggle="tooltip" title="<% translate("Reload Information"); %>" onclick="reloadPage(); return false;"><i class="icon-reboot"></i></a></div>
		<div class="content">
	...
	<script type="text/javascript">
		var c;
		c = [];
		c.push({ title: '<% translate("List only these IPs"); %>', name: 'f_filter_ip', size: 50, maxlen: 255, type: 'text', suffix: ' <small>(<% translate("Comma separated list"); %>)</small>' });
		...
		c.push({ title: '<% translate("Date Format"); %>', name: 'f_dafm', type: 'select', options: [['0', 'yyyy-mm'], ['1', 'mm-yyyy'], ['2', 'mmm, yyyy'], ['3', 'mm.yyyy']] });
