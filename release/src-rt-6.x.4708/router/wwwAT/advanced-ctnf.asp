...
<content>
	...
	<div class="box" data-box="ctnf-cons">
		<div class="heading"><% translate("Connections"); %></div>
		<div class="content">
			...
			<script type="text/javascript">
				$('.conectionsfirst').forms([
					{ title: '<% translate("Maximum Connections"); %>', name: 'ct_max', type: 'text', maxlen: 6, size: 8,
						suffix: '&nbsp; <a href="javascript:clicked()" id="count0">[ <% translate("count current"); %>... ]</a> <div class="spinner" style="visibility:hidden" id="spin" onclick="clicked()"></div>',
			...
			<button type="button" value="<% translate("Drop Idle"); %>" onclick="expireClicked()" id="expire" class="btn"><% translate("Drop Idle"); %> <i class="icon-disable"></i></button>
		</div>
	</div>

	<div class="box" data-box="ctnf-tcp-time">
		<div class="heading"><% translate("TCP Timeout"); %></div>
	...
	<div class="box" data-box="ctnf-udp-time">
		<div class="heading"><% translate("UDP Timeout"); %></div>
	...
	<div class="box" data-box="ctnf-timeout">
		<div class="heading"><% translate("Other Timeouts"); %></div>
	...
	<div class="box" data-box="ctnf-nat">
		<div class="heading"><% translate("Tracking / NAT Helpers"); %></div>
