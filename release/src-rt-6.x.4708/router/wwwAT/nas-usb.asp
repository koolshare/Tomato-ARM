...
<content>
	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="box" data-box="usb-supp">
			<div class="heading"><% translate("USB Support"); %></div>
			<div class="content">
				...
				<script type="text/javascript">
					...
					$('#usbfields').forms([
						...
						/* LINUX26-BEGIN */
						/* MICROSD-BEGIN */
						{ title: '<% translate("SD/MMC Card Support"); %>', indent: 2, name: 'f_mmc', type: 'checkbox', value: nvram.usb_mmc == 1 },
						/* MICROSD-END */
						/* LINUX26-END */
		...
		<div class="box" id="last-box" data-box="attached-devices">
			<div class="heading"><% translate("Attached Devices"); %></div>
			<div class="content">
