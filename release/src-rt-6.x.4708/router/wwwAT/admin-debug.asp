...
--><title><% translate("Debugging"); %></title>
<content>
	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="box">
			<div class="heading"><% translate("Debugging Settings & Information"); %></div>
			<div class="content">
				...
				&raquo; <a href="#clearcookies.asp"><% translate("Clear Cookies"); %></a><br>
				...
				&raquo; <a href="/nvram/nvram.txt?_http_id=<% nv(http_id); %>"><% translate("Download NVRAM Dump"); %></a>
			</div>
		</div>
