...
--><title><% translate("System Commands"); %></title>
<content>
	<style>
	...
	<div id="refresh"></div><button type="button" value="<% translate("Execute"); %>" onclick="execute()" id="execb" class="btn btn-primary"><% translate("Execute"); %> <i class="icon-cmd"></i></button>
