...
--><title><% translate("Bandwidth"); %>: <% translate("Monthly"); %></title>
<content>
	...
	<script type="text/javascript">
		...
		function redraw()
		{
			...
			grid += '<tr><td><b><% translate("Date"); %></b></td><td><b><% translate("Downloaded"); %></b></td><td><b><% translate("Uploaded"); %></b></th><td><b><% translate("Total"); %></b></td></tr>';
	...
	<div id="rstats" class="box">
		<div class="heading"><% translate("Monthly Bandwidth"); %> <a class="pull-right" href="#" data-toggle="tooltip" title="<% translate("Reload Information"); %>" onclick="reloadPage(); return false;"><i class="icon-reboot"></i></a></div>
		<div class="content">
