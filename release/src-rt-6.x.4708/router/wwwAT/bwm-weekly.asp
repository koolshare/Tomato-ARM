...
<content>
	...
	<div id="rstats" class="box">
		<div class="heading"><% translate("Weekly Bandwidth"); %> <a class="pull-right" href="#" data-toggle="tooltip" title="<% translate("Reload Information"); %>" onclick="reloadPage(); return false;"><i class="icon-reboot"></i></a></div>
		<div class="content">
