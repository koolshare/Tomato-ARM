...
--><title><% translate("Scheduler"); %></title>
<content>
	<style type="text/css">
		textarea {
			width: 95%;
	...
	<form name="_fom" id="_fom" method="post" action="tomato.cgi">
		...
		<div class="box" data-box="sched-reboot">
			<div class="heading"><% translate("Reboot"); %></div>
		...
		<div class="box" data-box="sched-reconnect">
			<div class="heading"><% translate("Reconnect"); %></div>
		...
		<div class="box" data-box="sched-cust1">
			<div class="heading"><% translate("Custom"); %> 1</div>
		...
		<div class="box" data-box="sched-cust2">
			<div class="heading"><% translate("Custom"); %> 2</div>
		...
		<div class="box" data-box="sched-cust3">
			<div class="heading"><% translate("Custom"); %> 3</div>
		...
		<div class="box" data-box="sched-cust4">
			<div class="heading"><% translate("Custom"); %> 4</div>
		...
		<div class="box" data-box="sched-cust5">
			<div class="heading"><% translate("Custom"); %> 5</div>
