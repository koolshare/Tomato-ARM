...
<content><style>
	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="box" data-box="router-log">
			<div class="heading"><% translate("Router Logging"); %></div>
		...
		<div class="box" data-box="webmon-settings">
			<div class="heading"><% translate("Web Monitor"); %></div>
			...
			<script type='text/javascript'>
				$('#webmon').forms([
					...
					{ title: '<% translate("IP Address(es)"); %>', indent: 2,  name: 'f_log_wmip', type: 'text', maxlen: 512, size: 64, value: nvram.log_wmip,
						suffix: '<small>(<% translate("ex:"); %> "1.1.1.1", "1.1.1.0/24" <% translate("or"); %> "1.1.1.1 - 2.2.2.2")</small>' },
