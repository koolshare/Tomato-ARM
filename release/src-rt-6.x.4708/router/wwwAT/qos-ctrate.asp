...
--><title><% translate("Per-Connection Transfer Rates"); %></title>
<content><style type="text/css">
	...
	<div class="box" id="qos-transfer-rates">
		<div class="heading"><% translate("QOS Transfer Rates"); %> <span id="numtotalconn"></span></div>
		<div class="content">
			...
			<script type="text/javascript">
				...
				c.push({ title: '<% translate("Ignore inactive connections"); %>', name: 'f_excludebythreshold', type: 'checkbox' });
